...
const Addkaryakartha = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // try {
    //   const response = await fetch('https://voters-be.onrender.com/addkaryakartha', {
    //     method: 'POST',
    //     headers: {
      ...
      <div className='addkaryakartha-con'>
        ...
        <div style={{marginBottom:'2rem'}}>
          <form className="max-w-sm mx-auto">
            {/* name */}
            <div className="mb-5">
              <label htmlFor="karyakarthaName" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                Karyakartha Name
              </label>
              <div className="flex">
            ...
            {/* Areaofworking */}
            <div className="mb-5">
              <label htmlFor="workingArea" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
            ...
            {/* Working under */}
            <div className="mb-5">
              <label htmlFor="workingUnder" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
            ...
            <div className="mb-5">
              <label htmlFor="assemblyConstituency" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
            ...
            <div className="mb-5">
              <label htmlFor="parliamentConstituency" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                Parliament Constituency
              </label>
              <input
                type="text"
                id="parliamentConstituency"
                className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
